  ...
  return (
    <section className="pt-20 pb-16 md:pt-32 md:pb-24 relative overflow-hidden">
      <div className="mx-auto max-w-3xl text-center space-y-6">
        ...
        <h1 className="px-2.5 text-5xl sm:text-6xl md:text-7xl text-gray-300 leading-tight tracking-tight font-instrument">
        ...
        <div className="flex items-center justify-center gap-4 pt-4">
          ...
          <Link href="/directory?category=ai">
            <Button
              size="lg"
              className="px-8 border border-white hover:bg-black"
            >
              Browse AI
            </Button>
          </Link>
